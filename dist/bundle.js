...
/***/ function(module, exports, __webpack_require__) {
	...
	var _intro = __webpack_require__(12);

	var _main = __webpack_require__(13);

	var _win = __webpack_require__(18);

	var _p = __webpack_require__(19);

	var _carrot = __webpack_require__(21);

	var _hog = __webpack_require__(22);

	var _hornet = __webpack_require__(23);

	var _bat = __webpack_require__(24);

	var _text = __webpack_require__(25);

	var _boom = __webpack_require__(26);

	var _bunny = __webpack_require__(27);

	var _fade = __webpack_require__(28);

	var _soundfx = __webpack_require__(29);
...
/***/ function(module, exports) {
	...
	exports.default = {
	  step0: [200, 40, 2, 2, 0.2, 2],
	  step1: [200, 40, 2, 2, 0.2, 2],
	  step2: [200, 40, 2, 2, 0.2, 2],
	  coin0: [500, 0, 10, 20, 0.05, 2],
	  coin1: [400, 0, 10, 20, 0.05, 2],
	  coin2: [300, 0, 10, 20, 0.05, 2],
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _nanotunes = __webpack_require__(11);

	var _nanotunes2 = _interopRequireDefault(_nanotunes);
	    ...
	    value: function init() {
	      ...
	      var tracks = {
	        start: {
	          bpm: 180,
	          isLooping: false,
	          parts: ['VOXA41A#41A41A#41G44C51']
	        },
	        dead: {
	          bpm: 120,
	          isLooping: false,
	          parts: ['VOXF31E31D31B31A#24']
	        },
	        title: {
	          bpm: 180,
	          isLooping: true,
	          parts: ['BSSC22C22G12G12A#12A#12B12B12G12E12G12E12']
	        }
	      };

	      this.g.music = new _nanotunes2.default(instruments, tracks);
	...
	var Intro = exports.Intro = function () {
	  ...
	  _createClass(Intro, [{
	    ...
	    value: function init() {
	      ...
	      this.addText('HALP!', 20);
	      this.addText('I AM', 100);
	      this.addText('LOST', 200);
	      this.addText('IN THE', 300);
	      this.addText('FOREST', 400);
	      this.addText('OF DOOM', 500);
	      this.addText('HALP ME', 700);
	      this.addText('GET HOME', 800);
	      this.addText('PLEASE', 950);
	      this.g.addEvent({
	        time: 1050,
	        cb: function cb() {
	      ...
	      this.sounds = ['step0', 'step1', 'step2', 'bounce'];
	      window.i = this.i;
	    }
	  }, {
	    key: 'update',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bridges = __webpack_require__(16);

	var _carrots = __webpack_require__(17);
	    ...
	    value: function pollInput() {
	      ...
	      if (newX !== this.x || newY !== this.y) {
	        ...
	        if (moveTo !== 2 && moveTo !== 4 && moveTo !== 5) {
	          this.g.score += 1;
	          this.changeAnim('run');
	          this.g.sfx.play('step' + this.g.H.rnd(0, 2));
